...
sounding_hodograph = function(ws, wd, altitude, max_hght = 2250, max_speed = 25,
                              lab_hghts = c(0, 0.5, 1, 1.5, 2),
  ...
  ux = approx(x = altitude, y = u, xout = seq(from = sfc, to = 500, by = 50))$y
  uy = approx(x = altitude, y = v, xout = seq(from = sfc, to = 500, by = 50))$y
  ux[1] = u[!is.na(u)][1]
  uy[1] = v[!is.na(v)][1]
  lines(ux, uy, lwd = 3, col = "magenta")

  ux = approx(x = altitude, y = u, xout = seq(from = 500, to = 1000, by = 50))$y
  uy = approx(x = altitude, y = v, xout = seq(from = 500, to = 1000, by = 50))$y
  # ux[1] = u[!is.na(u)][1]
  # uy[1] = v[!is.na(v)][1]
  lines(ux, uy, lwd = 3, col = "red")

  ux = approx(x = altitude, y = u, xout = seq(from = 1000, to = 1500, by = 50))$y
  uy = approx(x = altitude, y = v, xout = seq(from = 1000, to = 1500, by = 50))$y
  # ux[1] = u[!is.na(u)][1]
  # uy[1] = v[!is.na(v)][1]
  lines(ux, uy, lwd = 3, col = "orange")

  ux = approx(x = altitude, y = u, xout = seq(from = 1500, to = 2000, by = 50))$y
  uy = approx(x = altitude, y = v, xout = seq(from = 1500, to = 2000, by = 50))$y
  # ux[1] = u[!is.na(u)][1]
  # uy[1] = v[!is.na(v)][1]
